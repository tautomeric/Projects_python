# -*- coding: utf-8 -*-
"""
Uses portmanteau to analyize samples of portmanteaus 
...
class portmanteau_analyizer:
 def __init__(self,data):
  ...
  self.front_form_data = np.array([front_form],dtype=np.int8)   
  self.back_form_data = np.array([back_form],dtype=np.int8)  
  self.front_percent_data = np.array([front_percent],dtype=np.int8)  
  self.back_percent_data = np.array([back_percent],dtype=np.int8)  
  self.front_word_data = np.array([front_word],dtype=np.int8)  
  self.back_word_data = np.array([back_word],dtype=np.int8) 
